      ...
      <div class="relative overflow-hidden rounded-xl p-4 mb-4" style="background-color: var(--brand-dark);">
        ...
        <div class="relative z-10 flex items-center gap-4">
          ...
          <div class="flex-1 flex flex-col justify-center">
            <h1 class="text-xl font-bold text-white mb-1 animate-bounce-subtle text-left">
              🎯 POP-quiz
            </h1>
            <p class="text-sm text-white mb-1 font-medium animate-fade-in text-left">
              📺 Presentert av NRKs beste team
            </p>
            <p class="text-lg font-bold text-yellow-300 animate-glow text-left">
              ⭐ Team POP ⭐
            </p>
          </div>
        </div>
