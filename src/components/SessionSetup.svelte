...
<div class="min-h-screen bg-gradient-blue-orange flex items-center justify-center p-4">
      ...
      <div class="bg-brand-dark rounded-s p-6 mb-4">
        <div class="text-center">
          ...
          <div class="flex justify-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="203.681" height="43.956" viewBox="0 0 203.681 43.956">
  <g id="Group_194" data-name="Group 194" transform="translate(-385.865 -654.357)">
    ...
    <path id="Path_1851" data-name="Path 1851" d="M1.441-2.568H11.983L11.47,2.565H.888ZM38.32,17.925a8.869,8.869,0,0,1-2.409.79,15.1,15.1,0,0,1-3.04.316,7.873,7.873,0,0,1-5.587-1.9q-2.033-1.9-1.915-5.646a11.931,11.931,0,0,1-8.055-4.3q-2.8-3.554-2.8-9.753,0-7.068,3.593-10.878t10.069-3.81q6.476,0,10.049,3.791T41.794-2.647q0,6.081-2.645,9.615a11.541,11.541,0,0,1-7.581,4.4,2.929,2.929,0,0,0,1.382,1.6,4.461,4.461,0,0,0,2.093.494,7.514,7.514,0,0,0,2.093-.3,12.164,12.164,0,0,0,2.29-.967ZM28.172,5.685a4.612,4.612,0,0,0,4.106-2.073Q33.66,1.539,33.66-2.8q0-8.489-5.488-8.489A4.589,4.589,0,0,0,24.046-9.1a11.9,11.9,0,0,0-1.4,6.377q0,4.3,1.382,6.357A4.664,4.664,0,0,0,28.172,5.685Zm28.745,5.962q-6.16,0-9.2-2.606T44.677,1.46V-16.9h7.976V.2q0,3.119.987,4.343a4.242,4.242,0,0,0,3.475,1.224,3.606,3.606,0,0,0,3.277-1.4,9.288,9.288,0,0,0,.908-4.8V-16.9h6.949V.473q0,5.686-2.665,8.43T56.917,11.647Zm23.178-.513H72.119V-16.9h7.976Zm2.961,0V6.909l12-17.847H83.214V-16.9H104.93v4.225L92.848,5.171h12.833l-1.224,5.962Z" transform="translate(483.865 679.283)" fill="#fff"/>
  </g>
</svg>
