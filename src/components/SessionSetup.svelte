...
<svg xmlns="http://www.w3.org/2000/svg" width="195.339" height="42.097" viewBox="0 0 195.339 42.097">
  <g id="Group_194" data-name="Group 194" transform="translate(-385.865 -654.357)">
    ...
    <path id="Path_1851" data-name="Path 1851" d="M1.9-10.408H12.747l-.528,5.281H1.332Zm21.976,14.5A7.855,7.855,0,0,1,17.54,1.353q-2.315-2.742-2.315-7.82a13.581,13.581,0,0,1,1.381-6.4,9.671,9.671,0,0,1,3.737-3.981,10.21,10.21,0,0,1,5.2-1.361,10.386,10.386,0,0,1,2.519.284,10.285,10.285,0,0,1,2.112.772l7.19-1.1V12.1H29.6V2.1A9.208,9.208,0,0,1,23.877,4.094ZM23.024-6.873q0,3.047,1.178,4.326a4.2,4.2,0,0,0,3.25,1.28A8.566,8.566,0,0,0,29.6-1.511V-12.8q-.487-.081-.975-.122t-1.056-.041A4.105,4.105,0,0,0,24.243-11.5,7.179,7.179,0,0,0,23.024-6.873ZM47.8,4.094a7,7,0,0,1-5.179-1.889Q40.735.317,40.735-3.583V-17.151l7.84-1.137v13.2q0,2.8,3.006,2.8a8.037,8.037,0,0,0,2.844-.487l-.041-14.34,7.8-1.178L62.143,3.688H55.765L54.994.682a10.239,10.239,0,0,1-3.169,2.559A8.892,8.892,0,0,1,47.8,4.094Zm18-.406V-17.151l7.759-1.137V3.688ZM69.78-20.076a4.15,4.15,0,0,1-3.047-1.259,4.15,4.15,0,0,1-1.259-3.047,4.2,4.2,0,0,1,1.259-3.087,4.15,4.15,0,0,1,3.047-1.259,4.2,4.2,0,0,1,3.087,1.259,4.2,4.2,0,0,1,1.259,3.087,4.15,4.15,0,0,1-1.259,3.047A4.2,4.2,0,0,1,69.78-20.076ZM76.97,3.688,76.239-.5l9.506-11.821H76.239l.772-5.362H94.275l.731,4.753L86.069-1.633h9.668l-.731,5.321Z" transform="translate(485.467 684.357)" fill="#fff"/>
  </g>
</svg>
          ...
          <div>
            <p class="text-sm text-white mb-1">
              En produkt-team quiz fra Team POP i NRK. Del teamet ditt i to lag og svar på spørsmål. Konkurrer, spis kjeks, og le av litt rare AI-genererte spørsmål. Du kan enkelt fortsette over flere sesjoner ved å notere ned kodeordet.
            </p>
          </div>
        </div>
      </div>
    ...
    {#if mode === 'create'}
      ...
      <p class="block text-sm font-medium text-gray-700 mb-2">Dette kan også være fornavn på de på laget</p>
        <button
