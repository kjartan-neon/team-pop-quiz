...
<div class="bg-white rounded-xl shadow-lg p-6 mb-6">
  ...
  <div class="grid grid-cols-2 gap-4">
    <div class="p-6 rounded-xl border-2 transition-all {currentTurn === 1
      ...
      <div class="flex items-center gap-3 mb-3 mobile-team-header">
        ...
        {#if currentTurn === 1}
          <span class="bg-brand-dark text-white px-2 py-1 rounded-full text-sm font-medium desktop-turn-marker">
            DIN TUR
          </span>
        {/if}
      </div>
    ...
    <div class="p-6 rounded-xl border-2 transition-all {currentTurn === 2
      ...
      <div class="flex items-center gap-3 mb-3 mobile-team-header">
        ...
        {#if currentTurn === 2}
          <span class="bg-accent-dark text-white px-2 py-1 rounded-full text-sm font-medium desktop-turn-marker">
            DIN TUR
          </span>
        {/if}
      </div>
